const TermsOfService = () => (
  <section className="py-20 max-w-3xl mx-auto px-4">
    ...
    <div className="space-y-6 text-lg text-muted-foreground">
      <p>
        For the purpose of these Terms and Conditions, The term "we", "us", "our" used anywhere on this page shall mean NARASIMHA MANJUNATH PAI, whose registered/operational office is 'MAHATHI' 5-107 K6A 76 Badagubettu, Bailoor Udupi KARNATAKA 576101. "you", “your”, "user", “visitor” shall mean any natural or legal person who is visiting our website and/or agreed to purchase from us.
      </p>
      <p>
      ...
      <ul className="list-disc pl-6 space-y-2">
        ...
        <li>You may not create a link to our website from another website or document without NARASIMHA MANJUNATH PAI’s prior written consent.</li>
